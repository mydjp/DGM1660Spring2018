...
//Last modified: Thu, Feb 01, 2018 04:17:46 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.943130638370004 7.8086117500059444 31.758226731477215 ;
	setAttr ".r" -type "double3" -2.9383538249165344 -1082.3999999999285 -2.4869898575407213e-017 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "D0C034D3-4267-D142-A61C-81A5196645AB";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 32.589154018857492;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -10.750074664422046 5.9187660249657874 2.7826264348274066e-008 ;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" 0 7.4313653275439044 1000.3721930400358 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "4EBCE4B0-43B2-D8CD-8EFD-C1AA6E82BC6F";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 1000.3721930400358;
	setAttr ".ow" 15.675338429423116;
	setAttr ".imn" -type "string" "front";
	setAttr ".den" -type "string" "front_depth";
	setAttr ".man" -type "string" "front_mask";
	setAttr ".tp" -type "double3" 0 7.4313653275439044 0 ;
...
createNode transform -n "pPipe9";
	...
	setAttr ".s" -type "double3" 0.1354341416147869 0.1354341416147869 0.1354341416147869 ;
...
createNode transform -n "pPipe10";
	rename -uid "1027CBF5-46F8-72E6-4F21-759A0682D3E0";
	setAttr ".t" -type "double3" -6.6126223830949815 5.169594154141425 0 ;
	setAttr ".s" -type "double3" 0.1354341416147869 0.1354341416147869 0.1354341416147869 ;
createNode mesh -n "pPipeShape10" -p "pPipe10";
	rename -uid "B632D5E5-4729-6C72-0E83-57B4CC42A446";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pPipe11";
	rename -uid "6F005DD7-4E67-B78B-33C3-A598FC0E8FF2";
	setAttr ".t" -type "double3" -6.6126223830949815 4.7941661397312654 0 ;
	setAttr ".s" -type "double3" 0.1354341416147869 0.1354341416147869 0.1354341416147869 ;
createNode mesh -n "pPipeShape11" -p "pPipe11";
	rename -uid "B44D6F1B-4306-385B-197E-838F38B65B27";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
